...
from exercises.classifier import accuracy
from exercises.naive_bayes import predict_sentiment_nbc, calculate_smoothed_log_probabilities, \
    calculate_class_log_probabilities
from exercises.classifier import read_lexicon, predict_sentiment
